...
const SimplifiedCreateMeetingModal = ({ isOpen, onClose, onCreateMeeting }) => {
  const [formData, setFormData] = useState({
    ...
    meetingType: 'meeting',
    template: '',
    timezone: 'GMT+5:30 Mumbai, Kolkata, New Delhi',
...
export default SimplifiedCreateMeetingModal;
